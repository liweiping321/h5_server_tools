 ...
 */
@Handler(code=SceneMessages.C2S_SCENE_CHANGE_LINE)
public class SceneChangeLineHandler extends BaseHeroFightHandler {
    @Override
    public void doHandler(HeroFightModule hfm, ChannelBuffer buffer) throws Exception {
         // 以下代码为自动生成，请不要随意修改
          final int targetLine  = BufferUtil.readVarInt32(buffer);  //目标线数
         // 请在下面添加你的代码
    }
}
