 ...
 */
@Handler(code=SceneMessages.C2S_SCENE_HERO_JUMP)
public class SceneHeroJumpHandler extends BaseHeroFightHandler {
    @Override
    public void doHandler(HeroFightModule hfm, ChannelBuffer buffer) throws Exception {
         // 以下代码为自动生成，请不要随意修改
          final int jumpTargetX  = BufferUtil.readVarInt32(buffer);  //x坐标点
          final int jumpTargetY  = BufferUtil.readVarInt32(buffer);  //y坐标点
         // 请在下面添加你的代码
    }
}
