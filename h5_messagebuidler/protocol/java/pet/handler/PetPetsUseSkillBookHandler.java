 ...
 */
@Handler(code=PetMessages.C2S_PET_PETS_USE_SKILL_BOOK)
public class PetPetsUseSkillBookHandler extends BaseHeroFightHandler {
    @Override
    public void doHandler(HeroFightModule hfm, ChannelBuffer buffer) throws Exception {
         // 以下代码为自动生成，请不要随意修改
          final int templateId  = BufferUtil.readVarInt32(buffer);  //技能书模版ID
         // 请在下面添加你的代码
    }
}
